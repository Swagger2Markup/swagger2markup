...
public class Swagger2MarkupTest {
    ...
    public void convertRemoteSwaggerToAsciiDoc() {
        ...
        Swagger2MarkupConverter.from("http://localhost:8080/v2/api-docs").build()
            .intoFolder("build/docs/asciidoc/generated");
        //Then
        String[] files = new File("build/docs/asciidoc/generated").list();
        assertThat(directories).hasSize(3).containsAll(Arrays.asList("definitions.adoc", "overview.adoc", "paths.adoc"));
    }
    ...
    public void convertRemoteSwaggerToMarkdown() {
        ...
        //Then
        String[] files = new File("build/docs/asciidoc/generated").list();
        assertThat(directories).hasSize(3).containsAll(Arrays.asList("definitions.md", "overview.md", "paths.md"));
    }
