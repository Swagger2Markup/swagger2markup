...
This project is a Swagger to Markup (AsciiDoc and Markdown) converter. It takes a swagger.json or swagger.yaml file as input
and converts it into an AsciiDoc or Markdown file. The Swagger2Markup converter supports the Swagger 1.2 and 2.0 specification.
