...
== Example
== swagger.json
image::https://github.com/RobWin/swagger2markup/blob/master/images/swagger_json.PNG[swagger_json]

=== Generated AsciiDoc file
image::https://github.com/RobWin/swagger2markup/blob/master/images/asciidoc.PNG[asciidoc]

=== Generated Markdown file
image::https://github.com/RobWin/swagger2markup/blob/master/images/markdown.PNG[asciidoc]

=== Generated HTML
image::https://github.com/RobWin/swagger2markup/blob/master/images/asciidoc_html.PNG[asciidoc_html]
