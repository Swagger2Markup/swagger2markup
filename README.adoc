...
* New feature https://github.com/RobWin/swagger2markup/issues/21[RobWin/Swagger2Markup#21] by https://github.com/redowl[@redowl]: Support composed model defintions.
