...
The OverviewDocumentExtension allows to extend the overview document at four positions:
...
The PathsDocumentExtension allows to extend the paths document at six positions: 
...
The SecurityDocumentExtension allows to extend the security document at six positions: 
...
The DefinitionsDocumentExtension allows to extend the definitions document at six positions: 
...
By default, the markup language is set to *ASCIIDOC*, whatever the file extension. Set extension <<dynamic_file_extension_configuration,Configuration>> to change content markup language. 
...
[[dynamic_file_extension_configuration]]
===== Configuration
