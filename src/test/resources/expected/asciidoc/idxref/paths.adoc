...
|**Body**|**body** +
__optional__|Pet object that needs to be added to the store|<<definitions.adoc#_pet,Pet>>
|===
...
|Type|Name|Description|Schema
|**Body**|**body** +
__optional__|order placed for purchasing the pet|<<definitions.adoc#_order,Order>>
|===
...
|Type|Name|Description|Schema
|**Body**|**body** +
__optional__|Created user object|<<definitions.adoc#_user,User>>
|===
...
|Type|Name|Description|Schema
|**Body**|**body** +
__optional__|List of user object|< <<definitions.adoc#_user,User>> > array
|===
...
|**Body**|**body** +
__optional__|Updated user object|<<definitions.adoc#_user,User>>
|===
